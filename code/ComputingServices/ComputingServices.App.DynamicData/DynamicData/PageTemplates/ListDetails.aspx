<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="ListDetails.aspx.cs" Inherits="ComputingServices.App.DynamicData.ListDetails" %>
                    ...
                    <ItemTemplate>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                ...
                                <asp:LinkButton runat="server" CommandName="New" Text="新建" />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <EditItemTemplate>
